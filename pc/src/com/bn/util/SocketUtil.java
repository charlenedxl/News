	...
	{		
		...
		try
		{
			...
			if(newpc instanceof NewPC1)
			{
				...
				sb.append(newpc1.newsTitle);
				sb.append("<->");
				sb.append(newpc1.newsSummary);
				sb.append("<->");
				sb.append(newpc1.newsSources);
				sb.append("<->");
				sb.append(newpc1.releaseTime);
				sb.append("<->");
				sb.append(newpc1.newsContent);
				sb.append("<->");
				sb.append(newpc1.employeeId);
				sb.append("<->");
				sb.append(newpc1.newsStatus);
				sb.append("<->");
				sb.append(newpc1.formatId);
				if(add)
				{
					sb.append("<#ADD_NEW#>");
				}else
			...
			}else if(newpc instanceof NewPC2)
			{
				...
				sb.append(newpc2.newsTitle);
				sb.append("<->");
				sb.append(newpc2.newsSummary);
				sb.append("<->");
				sb.append(newpc2.newsSources);
				sb.append("<->");
				sb.append(newpc2.releaseTime);
				sb.append("<->");
				sb.append(newpc2.newsContent);
				sb.append("<->");
				sb.append(newpc2.employeeId);
				sb.append("<->");
				sb.append(newpc2.newsStatus);
				sb.append("<->");
				sb.append(newpc2.formatId);
				sb.append("<->");
			...
			}else if(newpc instanceof NewPC3)
			{
				...
				sb.append(newpc3.newsTitle);
				sb.append("<->");
				sb.append(newpc3.newsSummary);
				sb.append("<->");
				sb.append(newpc3.newsSources);
				sb.append("<->");
				sb.append(newpc3.releaseTime);
				sb.append("<->");
				sb.append(newpc3.newsContent);
				sb.append("<->");
				sb.append(newpc3.employeeId);
				sb.append("<->");
				sb.append(newpc3.newsStatus);
				sb.append("<->");
				sb.append(newpc3.formatId);
				sb.append("<->");
