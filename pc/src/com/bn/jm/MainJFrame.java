...
import com.bn.jm.AddNews.AddNewsPanel;
import com.bn.jm.AddNews.FormatSelectionPanel;
import com.bn.jm.AuditManage.AuditManagePanel;
import com.bn.jm.AuditManage.AuditPanel;
import com.bn.jm.AuditManage.CheckPanel;
import com.bn.jm.BasePermissions.BasePermissionsPanel;
import com.bn.jm.Department.DepartmentPanel;
import com.bn.jm.EmployeeManage.EmployeeManagePanel;
import com.bn.jm.NewsRelease.NewsReleasePanel;
import com.bn.jm.PersonalInformation.PersonalInformationPanel;
import com.bn.jm.PersonalNewsManager.EditNewsPanel;
import com.bn.jm.PersonalNewsManager.PersonalNewsManagerPanel;
import com.bn.jm.PersonalNewsManager.ViewAuditRecordsPanel;
import com.bn.jm.ProgramaManage.ProgramaManagePanel;
import com.bn.jm.ProgramaManage.ViewNewsPanel;
import com.bn.jm.RolePermissions.RolePermissionsPanel;
...
public class MainJFrame extends JFrame {
	...
	// 各页面引用
	private BasePermissionsPanel jbqxckPanel = null;// 基本权限查看
	private RolePermissionsPanel jsqxglPanel = null;// 角色权限管理
	private EmployeeManagePanel ygxxglPanel = null;// 员工信息管理
	private DepartmentPanel bmglPanel = null;// 员工信息管理
	private PersonalInformationPanel grxxgPanel = null;// 员工信息管理
	private AddNewsPanel xwxzPanel = null;// 新闻新增
	private PersonalNewsManagerPanel grxwglPanel = null;// 个人新闻管理
	private EditNewsPanel xwxgPanel = null;// 新增修改
	private AuditManagePanel shglPanel = null;// 审核管理
	private AuditPanel shPanel = null;// 审核界面
	private ProgramaManagePanel lmglPanel = null;// 审核界面
	private NewsReleasePanel fbxwckPanel = null;// 发布新闻查看界面
	private CheckPanel ckPanel = null;// 审核新闻查看界面
	private ViewAuditRecordsPanel ckshPanel = null;// 查看新闻相关审核记录界面
	private FormatSelectionPanel bsxzPanel = null;// 版式选择界面
	private ViewNewsPanel xwckPanel = null;// 新闻查看界面
	...
	protected void gotoJBQXCK() {
		if (jbqxckPanel == null) {
			jbqxckPanel = new BasePermissionsPanel();
		}
	...
	protected void gotoJSQXGL() {
		if (jsqxglPanel == null) {
			jsqxglPanel = new RolePermissionsPanel();
		}
	...
	protected void gotoYGXXGL() {
		if (ygxxglPanel == null) {
			ygxxglPanel = new EmployeeManagePanel();
		}
	...
	protected void gotoGRXXXG(String UserId) {
		if (grxxgPanel == null) {
			grxxgPanel = new PersonalInformationPanel(UserId);
		}
	...
	protected void gotoBSXZ() {
		if (bsxzPanel == null) {
			bsxzPanel = new FormatSelectionPanel(UserId,this);
		}
	...
	public void gotoXWXZ(int BSid) {
		if (xwxzPanel == null) {
			xwxzPanel = new AddNewsPanel(UserId,BSid);
	...
	public void gotoGRXWGL() {
		if (grxwglPanel == null) {
			grxwglPanel = new PersonalNewsManagerPanel(this,UserId);
		}
	...
	public void gotoCKSH(final String xwid) {
		if (ckshPanel == null) {
			ckshPanel = new ViewAuditRecordsPanel(this);
		}
	...
	public void gotoXWXG(final String xwid) {
		if (xwxgPanel == null) {
			xwxgPanel = new EditNewsPanel(this,UserId);
		}
	...
	public void gotoXWCK(final String xwid,boolean backLm) {
		if (xwckPanel == null) {
			xwckPanel = new ViewNewsPanel(this);
		}
	...
	public void gotoBackLMGL() 
	{
		if (lmglPanel == null) 
		{
			lmglPanel = new ProgramaManagePanel(this);
		}
	...
	public void gotoSHGL() {
		if (shglPanel == null) {
			shglPanel = new AuditManagePanel(this);
		}
	...
	public void gotoSH(final String shid) {
		if (shPanel == null) {
			shPanel = new AuditPanel(this, UserName);
		}
	...
	public void gotoFBXWCK() {
		if (fbxwckPanel == null) {
			fbxwckPanel = new NewsReleasePanel(this);
		}
